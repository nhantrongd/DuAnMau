        ...
        $page =$_GET['page']; 
            ...
            // Hàng hóa
				case "hh": 
                    ...
                    $ma_loai=$_POST['ma_loai'];
                    hh_insert($tenhh,$giahh,$giamhh,$hinh,$ngay,$mota,$viewhh,$ma_loai);
                    $thongbao="Thêm thành công";
                    } 
                    $loai=loai_selectall();
                ...
                case "updatehh":
                    ...
                    $viewhh=$_POST['so_luot_xem'];
                    $ma_loai=$_POST['ma_loai'];
                    hh_update($mahh,$tenhh,$giahh,$giamhh,$hinh,$ngay,$mota,$viewhh,$ma_loai);
                    $thongbao="Cập nhật thành công";
                    } 
                    $hanghoa=hh_selectall("",0);
                    include "hanghoa/dshanghoa.php";break;
            ...
            // Khách hàng
                ...
                case "updatekh":
                    ...
                    $ma_kh=$_POST['ma_kh'];
                    kh_update($mat_khau,$email,$ma_kh);
                    $thongbao="Cập nhật thành công";
                    } 
                    $khachhang=kh_selectall();
                    include "khachhang/dskhachang.php";break;
