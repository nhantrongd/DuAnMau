    ...
    <form class="color-form col-11 m-auto" action="index.php?page=hh" method="post" enctype="multipart/form-data">
        ...
        <div class="m-content">
            ...
            <div class="col-4">
                ...
                <input type="date" class="form-control" name="ngay_nhap" id="ngay_nhap" placeholder="Ngày">
            </div>
            <div class="col-4">
                <label for="so_luot_xem" class="form-label">Số lượt xem</label>
                <input type="number" class="form-control" readonly name="so_luot_xem" id="so_luot_xem" placeholder="Số lượt xem" value="0">
            </div>
        </div>
        </div>
        <div class="mb-5 px-3">
