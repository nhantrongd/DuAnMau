...
function hh_insert($tenhh,$giahh,$giamhh,$hinh,$ngay,$mota,$viewhh,$ma_loai){
    $sql="INSERT INTO hanghoa(ten_hh,don_gia,giam_gia,hinh,ngay_nhap,mo_ta,so_luot_xem,ma_loai) VALUES('$tenhh','$giahh','$giamhh','$hinh','$ngay','$mota','$viewhh','$ma_loai')";
    pdo_execute($sql);
}
...
function hh_update($mahh,$tenhh,$giahh,$giamhh,$hinh,$ngay,$mota,$viewhh,$ma_loai){
    if($hinh!="")
    $sql="UPDATE hanghoa SET ten_hh='".$tenhh."', don_gia='".$giahh."', giam_gia='".$giamhh."', hinh='".$hinh."', ngay_nhap='".$ngay."', mo_ta='".$mota."', so_luot_xem='".$viewhh."', ma_loai='".$ma_loai."' WHERE ma_hh=".$mahh;
    else
    $sql="UPDATE hanghoa SET ten_hh='".$tenhh."', don_gia='".$giahh."', giam_gia='".$giamhh."', ngay_nhap='".$ngay."', mo_ta='".$mota."', so_luot_xem='".$viewhh."', ma_loai='".$ma_loai."' WHERE ma_hh=".$mahh;
    pdo_execute($sql);
}
?>
...
function hh_selectall_favorite(){
    $sql="SELECT * FROM hanghoa WHERE 1 ORDER BY so_luot_xem DESC LIMIT 0,4";
    $hh=pdo_query($sql);
    return $hh;
}
