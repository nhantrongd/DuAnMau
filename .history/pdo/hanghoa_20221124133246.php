...
function hh_update($mahh,$tenhh,$giahh,$giamhh,$hinh,$mota,$viewhh,$ma_loai){
    if($hinh!="")
    $sql="UPDATE hanghoa SET ten_hh='".$tenhh."', don_gia='".$giahh."', giam_gia='".$giamhh."', hinh='".$hinh."', ngay_nhap='".$ngay."'_loai='".$ma_loai."' WHERE ma_hh=".$mahh;
    else, mo_ta='".$mota."', so_luot_xem='".$viewhh."', ma
