...
function bl_selectall($idproduct){
    ...
    $sql = "SELECT binhluanbinhluan.noi_dung, binhluan.ma_kh, binhluan.ma_hh, binhluan.ngay_bl, khachhang.username FROM ((binhluan INNER JOIN hanghoa ON hanghoa.ma_hh = binhluan.ma_hh) INNER JOIN khachhang ON khachhang.ma_kh = binhluan.ma_kh) WHERE hanghoa.ma_hh = " . $idproduct;
