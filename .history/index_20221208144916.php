			...
			<div class="fashion_area">
				...
				case "donhang":
					if(isset($_GET['huydon'])){
						bill_cancel($_GET['huydon']);
					}
					if(isset($_GET['danhan'])){
						bill_taken($_GET['danhan']);
					}
					if(isset($_GET['mualai'])){
						bill_repurchase($_GET['mualai']);
					}
					$ma_kh = $_SESSION['tk']['ma_kh'];
					$tcdonhang = orderBill_selectAllByIdUser($ma_kh);
					include "View/donhang.php";
					break;
				case "chitietdonhang":
					$tcdonhangchitiet = orderBill_selectAllByIdBill($_GET['id']);
					include "View/donhang.php";
					break;
				case "gioithieu": 	
