...
*/
            function sendEmail($emailAddress)
            {
                ...
                require "$CONTENT_URL/PHPMailer-master/src/PHPMailer.php";
                ...
                try {
                    ...
                    $mail->Password = "HungChien07020300117014/2";
                    $mail->SetFrom("leminhchien2611@gmail.com");
                    $mail->Subject = "Thế xác nhận email của bạn: "; //Tiêu đề
