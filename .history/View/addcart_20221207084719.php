        ...
        <div class="left-view">
            ...
            <div class="form-container">
                <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control" req>
                </div>
                <div class="form-group">
...
<script>
    ...
    for(let index = 0;index < cart_checkboxs.length;index++){
        cart_checkboxs[index].addEventListener(
            "click",
            function (event){
                if(event.target.checked == true){
                    ...
                    ipt_request.setAttribute("class","ipt_request");
                    ...
                    let cart_row = event.target.parentElement.parentElement;
                    let ipt_request = cart_row.querySelector(".ipt_request");
                    ipt_request.remove();
                }
