    ...
    <div class="register-right">
        ...
        <div class="form-container">
            ...
            <div class="margin form-group">
                ...
                <input type="text" name="mat_khau" placeholder="Mật khẩu cũ" required>
            </div>
            <div class="margin form-group">
                <label for="ten">Mật khẩu mới: </label> <br>
                <input type="text" name="mat_khau" placeholder="Mật khẩu mới" required>
            </div>
            <div class="margin form-group">
                <label for="ten">Nhập lại mật khẩu mới: </label> <br>
                <input type="text" name="mat_khau" placeholder="Nhập lại mật khẩu mới" required>
            </div>
