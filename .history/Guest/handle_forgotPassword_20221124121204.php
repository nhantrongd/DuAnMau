<?php  
    ...
    if(exist_param("btn_checkMail")){
        if(user_checkExistEmail($email)){
            ...
            header("location:../index.php?page=quenmk");
        }
        ...
        header("location:../index.php?page=quenmk&iptCode");
        ...
        if($ipt_code != $code){
            ...
            header("location:../index.php?page=quenmk&changePW");
        }
        ...
        if($refill_newPW !== $newPW){
            ...
            header("location:../index.php?page=quenmk&done");
        }
    }
?>